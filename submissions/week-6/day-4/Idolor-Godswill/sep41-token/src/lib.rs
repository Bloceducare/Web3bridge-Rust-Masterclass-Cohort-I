...
//! 
//! This crate provides a complete implementation of the SEP-41 token standard
//! for Stellar Soroban smart contracts. The implementation follows best practices
//! for security, efficiency, and interoperability.
//! 
//! ## Features
//! 
//! - Full SEP-41 compliance
//! - Administrative functions for token management
...
//! 
//! ```rust
//! use sep41_token::Token;
//! 
//! // Initialize the token
//! Token::initialize(env, admin, "MyToken".into(), "MTK".into(), 18);
//! 
//! // Mint initial supply
//! Token::mint(env, admin, 1_000_000_000_000_000_000);
//! 
//! // Transfer tokens
//! Token::transfer(env, from, to, 1000);
//! ```
