...
// pub fn create_allowance(e: &Env, from: Address, spender: &Address, amount: i128,
...
pub fn write_allowance(
    ...
    if amount > 0 && expiration_ledger < e.ledger().sequence() {
        panic!("expiration ledger is less than ledger seq when amount > 0")
    }
...
pub fn spend_allowance(e: &Env, from: Address, spender: Address, amount: i128) {
    ...
    if allowance.amount < amount {
        panic!("allowance is less than spend amount");
    }
